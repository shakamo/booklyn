...
class DailymotionTest < ActiveSupport::TestCase
  ...
  def test_1
    ...
    assert Video::Dailymotion.new.execute('http://www.dailymotion.com/video/x37onvu_%E3%81%8C%E3%81%A3%E3%81%93%E3%81%86%E3%81%90%E3%82%89%E3%81%97-12-gakkou-gurashi-12-end_shortfilms', content, episode)
  end
end
