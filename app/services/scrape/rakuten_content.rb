  ...
  class RakutenContent
    ...
    def self.create(season)
      ...
      if document == nil then
        ...
        raise 'RakutenContent データの取得に失敗しました。url:' + url
      end
