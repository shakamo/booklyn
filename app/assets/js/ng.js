...
.controller('ContentController', ['$rootScope', '$scope', '$http',
...
.controller('WeekController',['$rootScope', '$scope', '$http', '$routeParams',
  function($rootScope, $scope, $http, $routeParams) {
    $rootScope.contents = [];
...
.controller('AtozController', ['$rootScope', '$scope', '$http', '$routeParams',
  function($rootScope, $scope, $http, $routeParams) {
    $rootScope.contents = [];
    $scope.params = $routeParams;
    $http({
...
.controller('HowtoController', ['$scope', '$rootScope',
  function($scope, $rootScope, $routeParams) {
    $rootScope.isHowto = true;
  }
])
.controller('EpisodeController', ['$scope', '$http', '$routeParams', '$location', '$anchorScroll',
...
.controller('RightController', [ '$scope', '$http',
  function($scope, $http) {
    $http({
      method : 'GET',
      url : '/api/history'
