...
module GooLabs
  ...
  def get_api_key
    if Rails.application.config.goo_api_key_num < 4
      Settings.goo.api_key_1
    elsif Rails.application.config.goo_api_key_num < 7
      Settings.goo.api_key_2
    elsif Rails.application.config.goo_api_key_num < 10
      Settings.goo.api_key_3
    elsif Rails.application.config.goo_api_key_num < 13
